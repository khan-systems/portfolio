...
function ServicesSection() {
  ...
  return (
    <section id="services" className="py-16 md:py-24 bg-neutral-50 dark:bg-neutral-900">
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-neutral-600 dark:text-neutral-400 max-w-3xl mx-auto">
            From architecture audits to full migrations, I help companies build better React
            applications.
          </p>
        </motion.div>
