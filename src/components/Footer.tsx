function Footer() {
  ...
  return (
    <footer className="bg-neutral-900 dark:bg-black text-neutral-300 py-12 md:py-16 border-t border-neutral-800">
      <div className="container-custom">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          {/* Brand */}
          <div>
            <div className="text-2xl font-bold text-white mb-3">JK</div>
            <p className="text-sm text-neutral-400 leading-relaxed">
              Frontend architect specializing in React, TypeScript, and performance optimization.
            </p>
          </div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <button
                  ...
                  className="hover:text-white transition-colors focus:outline-none focus:underline text-left"
                >
                  Case Studies
                </button>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  href="https://github.com/junaidkhan-engineering"
                  target="_blank"
          ...
          <div>
            ...
            <p className="text-sm text-neutral-400 mb-4">
              Get notified about new case studies and availability.
            </p>
            <a
              href="mailto:junaidkhan.engineering@gmail.com?subject=Subscribe to updates"
